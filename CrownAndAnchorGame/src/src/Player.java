...
public class Player {
	...
	public boolean balanceExceedsLimit() {
        ...
        /** The method balanceExceedsLimitBy returns true or false if the difference between the balance and the amount is greater than the limit */        
	...
	/** The method toString returns the string of a player by displaying the player's name, balance, and limit */        
